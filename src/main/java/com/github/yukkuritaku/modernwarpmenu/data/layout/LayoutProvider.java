    ...
    private void addLayouts() {
        this.layouts.add(new LayoutFile(new Layout(Layout.LayoutType.OVERWORLD, Layout.EMPTY,
                List.of(
                        ...
                        new Island("Torrhus Canyon", new LayoutTexture(Identifier.fromNamespaceAndPath(ModernWarpMenu.MOD_ID,
                                "textures/gui/islands/canyon.png"), 756, 616),
                                1, 16, 0, 0.15f,
                                List.of(new Warp(13, 25, "Spawn", "torrhus"),
                                        new Warp(23, 11, "Springs", "springs"),
                                        new Warp(9, 14, "Critter Safari", "safari"))),
